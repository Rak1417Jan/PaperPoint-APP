...
class placeorderListcancelled extends StatefulWidget {
  const placeorderListcancelled({Key? key}) : super(key: key);

  @override
  State<placeorderListcancelled> createState() => _placeorderListStatecancelled();
}

class _placeorderListStatecancelled extends State<placeorderListcancelled> {
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                children: [
                  SizedBox(
                      width: screenWidth*0.375, child: _buildHeader("Cancelled", "Orders")),
                  Column(
                    children: [
                      // Image.asset(
                      ...
                      // ),
                      Lottie.asset('assets/orderCancelled.json',width: screenWidth*0.5,repeat: true),
  ...
  Future<List<PlaceOrderItem>> getOrdersForUser() async {
    ...
    QuerySnapshot querySnapshot = await orders.where('dispatchTime', whereIn: dispatchstatusList).
